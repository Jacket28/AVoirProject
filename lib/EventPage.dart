...
Widget _getEvent(BuildContext context, String eventId) {
  MyEvent event;
...
Future<MyEvent> _selectEvent(BuildContext context, String eventId) async {
  final DocumentSnapshot<Map<String, Object?>> event =
  ...
  MyEvent myEvent = MyEvent.fromJson(document!);
